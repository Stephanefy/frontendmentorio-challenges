        ...
        <div className="w-[290px] pt-8 h-screen relative bg-app-violet">
            <nav className={`h-full fixed top-24 left-0 bg-app-violet w-[238px]${fullWidth ? " transform translate-x-0" : "transform -translate-x-full" } pt-48  `}>
                <ul className="flex flex-col items-center flex-1 lg:items-start gap-y-16 text-white">
                    <li className="w-full">
                        <Link to="job-offers" className='pl-3 flex gap-x-10 cursor-pointer dark:text-white hover:border-r-4 hover:border-app-violet w-full hover:ease-in transition duration-150 group'>
                            <svg
                                ...
                                strokeWidth={1.5}
                                stroke="currentColor"
                                className="w-6 h-6 group-hover:stroke-app-violet group-hover:stroke-2"
                            >
                                <path
                                    strokeLinecap="round"
                            ...
                            <span className="hidden lg:block">Job offers</span>
                        </Link>
                    </li>
                    <li className="pl-3 flex gap-x-10 group cursor-pointer dark:text-white hover:border-r-4 hover:border-app-violet w-full hover:ease-in transition duration-150 ">
                        <svg
                            xmlns="http://www.w3.org/2000/svg"
                            fill="none"
                            viewBox="0 0 24 24"
                    ...
                    <li className="pl-3 flex gap-x-10 cursor-pointer group dark:text-white hover:border-r-4 hover:border-app-violet w-full hover:ease-in transition duration-150 ">
                        <svg
                            xmlns="http://www.w3.org/2000/svg"
                            fill="none"
                            viewBox="0 0 24 24"
